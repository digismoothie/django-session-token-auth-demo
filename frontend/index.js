...
function redirectThroughTurbolinks(isInitialRedirect = false) {
    const data = JSON.parse(document.getElementById('shopify-app-init').textContent);
...
document.documentElement.addEventListener("turbo:before-fetch-request", function (event) {
